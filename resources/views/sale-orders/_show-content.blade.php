    ...
    <div x-data="soShowPage()" id="so-show-view">
        ...
        @else
            <div class="mb-4 flex items-center justify-between">
                <h2 class="text-lg font-bold text-gray-900">Pedido {{ $saleOrder->number }}</h2>
                <button type="button" onclick="window.dispatchEvent(new CustomEvent('so-detail-modal-close'))"
                    class="flex h-9 w-9 items-center justify-center rounded-full bg-gray-100 text-gray-400 hover:bg-gray-200">
