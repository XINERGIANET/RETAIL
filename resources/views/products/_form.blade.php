<div x-data="{
    ...
    <div x-show="showBranchDetail" x-transition class="mb-8 p-6 bg-brand-50 dark:bg-brand-900/20 rounded-lg border border-brand-200 dark:border-brand-800">
