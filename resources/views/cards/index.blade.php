            ...
            <form method="GET" class="flex flex-1 flex-col gap-3 sm:flex-row sm:items-center">
                ...
                <div class="relative flex-1">
                    ...
                    <input type="text" name="search" value="{{ $search ?? '' }}" placeholder="Buscar por descripcion"
                        class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 pl-12 text-sm text-gray-800 placeholder:text-gray-400" />
                </div>
                <div class="flex flex-wrap gap-2">
                    ...
                    <x-ui.link-button size="md" variant="outline"
                        href="{{ $viewId ? route('admin.cards.index', ['view_id' => $viewId]) : route('admin.cards.index') }}"
                    ...
                    <thead class="text-left text-theme-xs dark:text-gray-400">
                        <tr class="border-b border-gray-100 dark:border-gray-800">
                            <th style="background-color: #334155; color: #FFFFFF"
                                class="px-5 py-3 text-center sm:px-6 sticky-left-header first:rounded-tl-xl">
                                ID
                            </th>
    ...
    <x-ui.modal x-data="{ open: false }" @open-create-card-modal.window="open = true"
        ...
        <div class="p-6 space-y-4">
            ...
            <form id="create-card-form" class="space-y-4"
                action="{{ $viewId ? route('admin.cards.store') . '?view_id=' . $viewId : route('admin.cards.store') }}"
