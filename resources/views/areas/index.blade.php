...
@section('content')
    ...
    <div x-data="{}">
                ...
                <form method="GET" class="flex flex-1 flex-col gap-3 sm:flex-row sm:items-center min-w-0">
                    ...
                    <div class="flex items-center gap-2 flex-none">
                        ...
                        <x-ui.link-button size="md" variant="outline"
                            href="{{ route('areas.index', $viewId ? ['view_id' => $viewId] : []) }}"
        ...
        <x-ui.modal x-data="{ open: false }" @open-area-modal.window="open = true" @close-area-modal.window="open = false"
