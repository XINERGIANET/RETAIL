...
@section('content')
    <div x-data="{}">
        ...
        <x-common.component-card title="Mesas" desc="Gestiona todas las mesas.">
                ...
                <form method="GET" class="flex flex-1 flex-col gap-3 sm:flex-row sm:items-center">
                    ...
                    <div class="flex flex-wrap gap-2">
                        ...
                        <x-ui.link-button size="md" variant="outline"
                            href="{{ route('tables.index', $viewId ? ['view_id' => $viewId] : []) }}"
                    ...
                    @foreach ($topOperations as $operation)
                        ...
                        @if ($isCreate)
                            <x-ui.button size="md" variant="primary" type="button" style="{{ $topStyle }}"
                                @click="$dispatch('open-table-modal')">
            ...
            <div
                class="mt-4 table-responsive lg:!overflow-visible rounded-xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                        ...
                        @forelse ($tables as $table)
                            <tr
                                ...
                                <td class="px-5 py-4 sm:px-6">
                                    <p class="text-gray-500 text-theme-sm dark:text-gray-400">{{ $table->capacity ?? '-' }}
                                    </p>
                                </td>
                                <td class="px-5 py-4 sm:px-6">
                                ...
                                <td class="px-5 py-4 sm:px-6">
                                    <x-ui.badge variant="light"
                                        color="{{ $table->situation === 'ocupada' ? 'warning' : 'success' }}">
        ...
        <x-ui.modal x-data="{ open: false }" @open-table-modal.window="open = true"
            @close-table-modal.window="open = false" :isOpen="false" :showCloseButton="false" class="max-w-3xl">
