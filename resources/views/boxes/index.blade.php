                    ...
                    <thead>
                        <tr class="border-b border-gray-100 dark:border-gray-800">
                            <th class="px-5 py-3 text-left sm:px-6 first:rounded-tl-xl">
                                <p class="font-medium text-white text-theme-xs dark:text-white">ID</p>
                            </th>
                            <th class="px-5 py-3 text-left sm:px-6">
                                <p class="font-medium text-white text-theme-xs dark:text-white">Numero</p>
                            </th>
                            <th class="px-5 py-3 text-left sm:px-6">
                                <p class="font-medium text-white text-theme-xs dark:text-white">Serie</p>
                            </th>
                            <th class="px-5 py-3 text-left sm:px-6">
