...
@section('content')
    ...
    <div x-data="{}">
                                        ...
                                        @foreach ($rowOperations as $operation)
                                            ...
                                            @if ($isDelete)
                                                <form method="POST" action="{{ $actionUrl }}"
                                                    class="relative group js-swal-delete" data-swal-title="Eliminar unidad?"
                            ...
                            <tr>
                                <td colspan="6" class="px-6 py-12">
                                    <div class="flex flex-col items-center gap-3 text-center text-sm text-gray-500">
                                        ...
                                        <p class="text-base font-semibold text-gray-700 dark:text-gray-200">No hay unidades
                                            registradas.</p>
        ...
        <x-ui.modal x-data="{ open: false }" @open-unit-modal.window="open = true" @close-unit-modal.window="open = false"
            ...
            <div class="p-6 sm:p-8">
                ...
                <form method="POST"
                    action="{{ $viewId ? route('admin.units.store') . '?view_id=' . $viewId : route('admin.units.store') }}"
                    class="space-y-6">
                    @csrf
                    @if ($viewId)
                        <input type="hidden" name="view_id" value="{{ $viewId }}">
