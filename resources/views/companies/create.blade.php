...
@section('content')
    ...
    <x-ui.modal x-data="{
            ...
            }" :isOpen="true" :showCloseButton="false" class="max-w-3xl">
        <div class="p-6 sm:p-8">
            <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h3 class="text-lg font-semibold text-gray-800 dark:text-white/90">Nueva empresa</h3>
            ...
            <form method="POST"
                action="{{ $viewId ? route('admin.companies.store') . '?view_id=' . $viewId : route('admin.companies.store') }}"
                class="space-y-6">
                @csrf
                @if ($viewId)
