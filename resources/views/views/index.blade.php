...
@section('content')
    <div x-data="{}">
        ...
        <x-common.component-card title="Gestión de Vistas"
            desc="Administra las vistas del sistema para asociarlas a los menús.">
            ...
            <div class="flex flex-col gap-4 mb-6 xl:flex-row xl:items-center xl:justify-between">
                <form method="GET" class="flex flex-1 flex-wrap gap-2 sm:flex-nowrap sm:items-center min-w-0">
                    ...
                    <div class="relative flex-1 min-w-0">
                        ...
                        <input type="text" name="search" value="{{ request('search') }}" placeholder=" Buscar vista..."
                    ...
                    <div class="flex items-center gap-2 flex-none">
                        ...
                        <x-ui.link-button size="md" variant="outline"
                            href="{{ route('admin.views.index', $viewId ? ['view_id' => $viewId] : []) }}"
                ...
                <table class="w-full min-w-max">
                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                        @forelse ($views as $view)
                            <tr
                                class="group/row transition hover:bg-gray-50/80 dark:hover:bg-white/5 relative hover:z-[60]">
                                        ...
                                        @foreach ($rowOperations as $operation)
                                            ...
                                            @if ($isDelete)
                                                <form method="POST" action="{{ $actionUrl }}"
                                                    class="relative group js-swal-delete" data-swal-title="Eliminar vista?"
                            ...
                            <tr>
                                <td colspan="5" class="px-6 py-16">
                                    <div class="flex flex-col items-center gap-4 text-center">
                                        ...
                                        <p class="text-base font-semibold text-gray-800 dark:text-white/90">No hay vistas
                                            registradas</p>
                                    </div>
                                </td>
                            </tr>
        ...
        <x-ui.modal x-data="{ open: {{ $errors->any() ? 'true' : 'false' }} }" @open-view-modal.window="open = true" @close-view-modal.window="open = false"
